...
[x] /v2/sports/{sport}/leagues/{league}/seasons/{year}/types/{seasontype}/teams/{teamId}/odds-records - Team Odds Records. Path Params: {sport}, {league}, {year}, {seasontype} (typically 0), {teamId} - Implemented as generic endpoint (NFL confirmed working)
