...
from models.espn_nfl_api_client.api.default.get_nfl_teams_list import sync
from models.espn_nfl_api_client.models.error_response import ErrorResponse
from models.espn_nfl_api_client.models.teams_list_response import TeamsListResponse
...
def main():
    ...
    try:
        ...
        for team_entry in league.get("teams", []):
            ...
            print(f"{team.get('displayName', 'Unknown')} ({team.get('abbreviation', 'UNK')})")
