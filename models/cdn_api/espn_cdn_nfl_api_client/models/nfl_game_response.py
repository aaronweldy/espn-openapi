...
if TYPE_CHECKING:
    from ..models.nfl_game_response_ads import NflGameResponseAds
    from ..models.nfl_game_response_analytics import NflGameResponseAnalytics
    from ..models.nfl_game_response_content import NflGameResponseContent
    from ..models.nfl_game_response_gamepackage_json import NflGameResponseGamepackageJSON
    from ..models.nfl_game_response_meta import NflGameResponseMeta
    from ..models.nfl_game_response_targeting import NflGameResponseTargeting
    from ..models.nfl_game_response_tier_2_nav import NflGameResponseTier2Nav


T = TypeVar("T", bound="NflGameResponse")


@_attrs_define
class NflGameResponse:
    """NFL game details response with boxscore, drives, leaders, and more

    Attributes:
        game_id (Union[Unset, int]): The game ID
        gamepackage_json (Union[Unset, NflGameResponseGamepackageJSON]): Game package data including boxscore, drives,
            leaders, etc.
        custom_style_sheet (Union[Unset, str]):
        type (Union[Unset, str]):
        content (Union[Unset, NflGameResponseContent]):
        field_gamepackage (Union[Unset, bool]):
        analytics (Union[Unset, NflGameResponseAnalytics]):
        ads (Union[Unset, NflGameResponseAds]):
        targeting (Union[Unset, NflGameResponseTargeting]):
        meta (Union[Unset, NflGameResponseMeta]):
        now_feed_supported (Union[Unset, bool]):
        custom_nav (Union[Unset, str]):
        sport (Union[Unset, List[str]]):
        tier_2_nav (Union[Unset, NflGameResponseTier2Nav]):
    """

    game_id: Union[Unset, int] = UNSET
    gamepackage_json: Union[Unset, "NflGameResponseGamepackageJSON"] = UNSET
    custom_style_sheet: Union[Unset, str] = UNSET
    type: Union[Unset, str] = UNSET
    content: Union[Unset, "NflGameResponseContent"] = UNSET
    field_gamepackage: Union[Unset, bool] = UNSET
    analytics: Union[Unset, "NflGameResponseAnalytics"] = UNSET
    ads: Union[Unset, "NflGameResponseAds"] = UNSET
    targeting: Union[Unset, "NflGameResponseTargeting"] = UNSET
    meta: Union[Unset, "NflGameResponseMeta"] = UNSET
    now_feed_supported: Union[Unset, bool] = UNSET
    custom_nav: Union[Unset, str] = UNSET
    sport: Union[Unset, List[str]] = UNSET
    tier_2_nav: Union[Unset, "NflGameResponseTier2Nav"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        gamepackage_json: Union[Unset, NflGameResponseGamepackageJSON]
        if isinstance(_gamepackage_json, Unset):
            gamepackage_json = UNSET
        else:
            gamepackage_json = NflGameResponseGamepackageJSON.from_dict(_gamepackage_json)
        ...
        if isinstance(_content, Unset):
            ...
            content = NflGameResponseContent.from_dict(_content)
        ...
        if isinstance(_analytics, Unset):
            ...
            analytics = NflGameResponseAnalytics.from_dict(_analytics)
        ...
        if isinstance(_ads, Unset):
            ...
            ads = NflGameResponseAds.from_dict(_ads)
        ...
        if isinstance(_targeting, Unset):
            ...
            targeting = NflGameResponseTargeting.from_dict(_targeting)
        ...
        if isinstance(_meta, Unset):
            ...
            meta = NflGameResponseMeta.from_dict(_meta)
        ...
        if isinstance(_tier_2_nav, Unset):
            ...
            tier_2_nav = NflGameResponseTier2Nav.from_dict(_tier_2_nav)

        nfl_game_response = cls(
            game_id=game_id,
        ...
        nfl_game_response.additional_properties = d
        return nfl_game_response
