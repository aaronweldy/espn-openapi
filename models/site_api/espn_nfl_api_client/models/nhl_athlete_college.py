...
T = TypeVar("T", bound="NhlAthleteCollege")


@_attrs_define
class NhlAthleteCollege:
    """
    Attributes:
        id (Union[Unset, str]):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        nhl_athlete_college.additional_properties = d
        return nhl_athlete_college
