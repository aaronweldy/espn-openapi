...
T = TypeVar("T", bound="ThursdayNightFootballResponse")


@_attrs_define
class ThursdayNightFootballResponse:
    """
    Attributes:
        leagues (List['League']):
        season (SeasonInfo):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        thursday_night_football_response = cls(
            leagues=leagues,
            season=season,
            events=events,
        )

        thursday_night_football_response.additional_properties = d
        return thursday_night_football_response
