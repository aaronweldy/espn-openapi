...
T = TypeVar("T", bound="MondayNightFootballResponse")


@_attrs_define
class MondayNightFootballResponse:
    """
    Attributes:
        leagues (List['League']):
        season (SeasonInfo):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        monday_night_football_response = cls(
            leagues=leagues,
            season=season,
            events=events,
        )

        monday_night_football_response.additional_properties = d
        return monday_night_football_response
