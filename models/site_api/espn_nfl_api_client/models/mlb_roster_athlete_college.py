...
T = TypeVar("T", bound="MlbRosterAthleteCollege")


@_attrs_define
class MlbRosterAthleteCollege:
    """
    Attributes:
        id (Union[Unset, str]):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        mlb_roster_athlete_college = cls(
            id=id,
            guid=guid,
            mascot=mascot,
            name=name,
        ...
        mlb_roster_athlete_college.additional_properties = d
        return mlb_roster_athlete_college
