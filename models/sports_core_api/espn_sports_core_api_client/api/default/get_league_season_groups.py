...
from ...models.get_league_season_groups_season_type import GetLeagueSeasonGroupsSeasonType
...
def _get_kwargs(
    ...
    league: LeagueEnum,
    year: int,
    season_type: GetLeagueSeasonGroupsSeasonType,
    *,
    ...
    _kwargs: Dict[str, Any] = {
        "method": "get",
        "url": f"/v2/sports/{sport}/leagues/{league}/seasons/{year}/types/{season_type}/groups",
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    """Get League Season Groups

     Retrieve the list of groups (conferences/divisions) for a given season and season type in a league
    and sport. Returns a paginated list of group resource references.
    ...
    Args:
        ...
        season_type (GetLeagueSeasonGroupsSeasonType):  Example: 2.
