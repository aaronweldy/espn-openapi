...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: Dict[str, Any] = {
        "method": "get",
        "url": f"/v2/sports/{sport}/leagues/{league}/seasons/{year}/coaches",
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    """Get Season Coaches List

     Retrieve a paginated list of coaches for a specific sport, league, and season.
