...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: Dict[str, Any] = {
        "method": "get",
        "url": f"/v2/sports/{sport}/leagues/{league}/seasons/{year}/types/{season_type}/weeks",
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    """Get League Season Weeks

     Retrieve the list of weeks for a given season and season type in a league and sport. Returns a
