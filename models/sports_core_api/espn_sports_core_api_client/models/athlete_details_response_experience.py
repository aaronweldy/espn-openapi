...
T = TypeVar("T", bound="AthleteDetailsResponseExperience")


@_attrs_define
class AthleteDetailsResponseExperience:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        athlete_details_response_experience = cls(
            years=years,
            display_value=display_value,
        )

        athlete_details_response_experience.additional_properties = d
        return athlete_details_response_experience
