...
T = TypeVar("T", bound="StatisticCategory")
...
class StatisticCategory:
    ...
    Attributes:
        ...
        short_display_name (Union[Unset, str]):  Example: Passing.
        abbreviation (Union[Unset, str]):  Example: PASS.
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for stats_item_data in _stats:
            stats_item = Statistic.from_dict(stats_item_data)
        ...
        statistic_category.additional_properties = d
