...
if TYPE_CHECKING:
    from ..models.nfl_team_depthchart_item import NflTeamDepthchartItem
...
class NflTeamDepthchartResponse:
    ...
    Attributes:
        ...
        page_size (int):
        page_count (int):
        items (List['NflTeamDepthchartItem']):
    """
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for items_item_data in _items:
            items_item = NflTeamDepthchartItem.from_dict(items_item_data)
