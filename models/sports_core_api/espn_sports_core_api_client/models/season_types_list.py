...
T = TypeVar("T", bound="SeasonTypesList")


@_attrs_define
class SeasonTypesList:
    """
    Attributes:
        ref (Union[Unset, str]):
        ...
        items (Union[Unset, List['SeasonType']]):
    """
    ...
    items: Union[Unset, List["SeasonType"]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for items_item_data in _items or []:
            items_item = SeasonType.from_dict(items_item_data)

            items.append(items_item)

        season_types_list = cls(
            ref=ref,
            count=count,
        ...
        season_types_list.additional_properties = d
        return season_types_list
