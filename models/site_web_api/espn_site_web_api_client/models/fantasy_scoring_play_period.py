...
T = TypeVar("T", bound="FantasyScoringPlayPeriod")


@_attrs_define
class FantasyScoringPlayPeriod:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        fantasy_scoring_play_period = cls(
            number=number,
            display_value=display_value,
        )

        fantasy_scoring_play_period.additional_properties = d
        return fantasy_scoring_play_period
